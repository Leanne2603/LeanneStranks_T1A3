...
def run_quiz(subject)
    ...
    font = TTY::Font.new
        ...
        case score
        when 0..3 then
            puts Rainbow("Your score was #{score}/10. There is room for improvement").pink
        when 4..7 then
            puts Rainbow("Your score was #{score}/10. Well done").pink
        when 8..10 then
            puts Rainbow("Your score was #{score}/10. Amazing work!").pink
        end
    rescue
